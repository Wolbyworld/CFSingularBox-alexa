    ...
    var testMode = config.verification;
    ...
    function dbHelper () {
         ...
         * */
        this.readTodaysCFWorkout = async function (_testMode) {
            testMode=_testMode;
         ...
         * Returns today´s CF workout from the database in an object form
         * */
        this.readTodaysCFFWorkout = async function (_testMode) {
            testMode=_testMode;
         ...
         * Returns today´s CF workout from the database in an object form
         * */
        this.readTodaysPerformanceWorkout = async function (_testMode) {
            testMode=_testMode;
